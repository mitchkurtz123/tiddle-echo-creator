  ...
  return (
    <div className="py-16 bg-gradient-to-b from-white to-blue-50">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-[#40377A] mb-12">Our Top Creators</h2>
          ...
          {creators.map((creator, index) => (
            <div key={index} className="flex flex-col items-center">
              ...
              <a 
                ...
                className="text-tiddle-purple font-medium text-center hover:underline"
              >
                {creator.username}
              </a>
            </div>
